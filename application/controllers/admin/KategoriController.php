...
class KategoriController extends CI_Controller {
	...
	public function daftarKategori()
	{
		...
		$this->load->view('admin/pages/daftar_kategori');
    ...
    public function pagination()
    {
        ...
        $config['base_url'] = site_url('admin/produk/daftar-kategori/'); //site url
        ...
        $data['data'] = $this->KategoriModel->_readKategori($config["per_page"], $data['page']);           
