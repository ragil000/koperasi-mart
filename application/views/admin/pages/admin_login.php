            ...
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				...
				<form class="login100-form validate-form" method="POST" action="<?=base_url('admin/login')?>">
					...
					<div class="wrap-input100 validate-input m-b-23" data-validate = "Username tidak boleh kosong">
						...
						<input class="input100" type="text" name="tb_akun_username" placeholder="username">
						<span class="focus-input100" data-symbol="&#xf206;"></span>
					</div>

					<div class="wrap-input100 validate-input" data-validate="Password tidak boleh kosong">
						<span class="label-input100">Password</span>
						<input class="input100" type="password" name="tb_akun_password" placeholder="password">
						<span class="focus-input100" data-symbol="&#xf190;"></span>
					</div>
