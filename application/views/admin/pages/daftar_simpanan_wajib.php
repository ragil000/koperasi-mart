...
?>
                    ...
                    <div class="page-inner">
                        <div class="page-title">
                            <h3 class="breadcrumb-header">Daftar Simpanan Wajib</h3>
                        </div>
                        <div id="main-wrapper">
                            <div class="row">
                                <form method="POST" action="<?=base_url('admin/anggota/daftar-simpanan-wajib/create')?>" id="form_tambah_simpanan" name="form_tambah_simpanan">
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        ...
                                                        <h4 class="modal-title" id="myModalLabel">Tambah Simpanan Wajib</h4>
                                                    </div>
                                                    ...
                                                    <div class="modal-footer">
                                                        <button type="submit" onclick="simpan()" class="btn btn-success" data-dismiss="modal">Simpan</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="panel panel-white">
                                        <div class="panel-heading clearfix">
                                            <h4 class="panel-title">List Simpanan Wajib</h4>
                                        </div>
